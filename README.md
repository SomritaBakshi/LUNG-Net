...
The 'Data/' folder in this repository shows the expected directory structure. Actual data will be shared upon reasonable request.
## Code
...
## Trained Model
The trained models will be made available upon reasonable request in the folder 'Models/'.
